...
namespace admin
{
    public partial class frmmenuPrincipal : Form
    {
        ...
        private void reporteDeAcumuladoDePuntosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmReAcumulado form = new frmReAcumulado();
            form.Show();
        }

        private void reporteDePeliculasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmRePeliculas form = new frmRePeliculas();
            form.Show();
        }

        private void reporteDeGananciasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmReGanancias form = new frmReGanancias();
            form.Show();
        }

        private void reporteDeHorariosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmReHorarios form = new frmReHorarios();
            form.Show();
        }
    }
}
