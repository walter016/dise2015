    ...
    public partial class frmInformacion : Form
    {
        ...
        private void informacion_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = "SELECT mapelicula.vtitulo, mapelicula.dcosto, mapelicula.vtipoSala, mapelicula.vclasificacion, mapelicula.vcategoria,mapelicula.velenco,mapelicula.vidioma,mapelicula.vsubtitulo,trhorario.thorainicio,trhorario.thorafinal,CONCAT(thorainicio,'         -             ',thorafinal) AS Hora ,mapelicula.bimagen FROM mapelicula" +
                " INNER JOIN trhorario ON mapelicula.iidpelicula = trhorario.iidPelicula WHERE trhorario.iidPelicula = '" + claseEmp.MyIdMovie + "'";
                MySqlCommand comando = new MySqlCommand(sql, clascrearConexion.Conexion());
