//La función del siguiente formulario es la de elegir la ciudad y la sucursal para consultar peliculas disponibles
...
namespace WindowsFormsApplication1
{
    public partial class frmCiudad : Form
    {
        ...
        {
            //Se carga el datatable ciudades para que cuando se cambie de ciudad se carguen las sucursales respectivas
            ciudades();
        }
